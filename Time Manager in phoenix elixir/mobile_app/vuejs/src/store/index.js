...
const store = createStore({
    ...
    state: {
        ...
        Navbar: [
            ...
            {role: 'Manager', name: "Departure & Arrival employees", action: "/arrivalDepartureEmployees", style: ""},
            {role: 'Manager', name: "Employees schedules", action: "/employeesSchedules", style: ""},
